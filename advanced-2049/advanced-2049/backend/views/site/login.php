...
<div class="container">   
    ...
    <div class="row">      
      <div class="col-md-4 offset-md-4" >                                             <!--#f2f2f2  #33d6ff -->
        <div class="account-wall" align=center style="Background-color:#ffffff;
                ...
                <img src= <?php echo Url::to('@web/archivos/sipvadi.png',true);?> width="60%"
                                                                                 height="35%"
                                                                                 BORDER=0
                ...
                <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
                    ...
                    <div class="form-group">
                        <?= Html::submitButton('INICIAR SESIÓN', ['class' => 'btn btn-lg btn-primary btn-block', 'name' => 'login-button']) ?>
                    </div>
                <?php ActiveForm::end(); ?>                  
        </div > <!-- account-wall -->      
